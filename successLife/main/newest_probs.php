    ...
    <div class="main" id="main">
        ...
        <div id="wrapper">
            <table class="table">
                ...
                <tbody>
                <?php
                    $get_newest = "SELECT * FROM PROBLEM order by `id` DESC;";
                    $newest_sql = mysqli_query($conn, $get_newest);
                    while ($newest_row = mysqli_fetch_array($newest_sql)) {
                        $probId = $newest_row['id'];
                        $probTitle = $newest_row['title'];
                        $probWriter = $newest_row['writer'];
                        $probSubject = $newest_row['subject'];
                        $probChall = $newest_row['challenged'];
                        $probSol = $newest_row['solved'];
