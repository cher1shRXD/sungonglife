...
<body>
    <?php include_once "../backend/mysql_conn.php" ?>
    ...
    <?php include_once "../main/mobile_menu.php" ?>
        <div class="main" id="main">
            <h1>선생님인가요, 학생인가요?</h1>
            <div id="choose_job">
                <div id="teacher" class="choose_box" onclick="register_teacher();">
                    <h2>선생님</h2>
                    <p>현재 재직중인 선생님입니다.</p>
                </div>
                <div id="student" class="choose_box"onclick="register_student();">
                    <h2>학생</h2>
                    <p>현재 재학중인 학생입니다.</p>
                </div>
            </div>
